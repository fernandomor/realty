...
export default function Resultado() {
    ...
    const { ciudad, tipo, categoria } = useParams()

    const [nodata , setNodata] = useState(false)
    const { data } = useQuery(GET_PROPERTY_BY_CITY_TYPE_CATEGORY, { variables: { ciudad: ciudad, tipo: tipo, cat: categoria } })
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                            ...
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                ...
                                <Link to={`/resumen/propiedad/${product.id}`}  >
                                    <button
                                        type="button"
                                        className="inline-flex mt-2 items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-full shadow-sm text-white bg-black hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
                                    >
                                        ver más
                                    </button>
                                </Link>
